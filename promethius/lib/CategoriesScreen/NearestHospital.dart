...
class _MapsState extends State<Maps> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
        appBar: AppBar(title: Text('Get your Nearest hospitals')),
        body: FlutterMap(
          options: MapOptions(
          ...
          layers: [
            ...
            MarkerLayerOptions(markers: [
              ...
              //1st
              Marker(
                  point: latLng.LatLng(27.674597, 85.31502),
                  builder: ((context) => Container(
                    child: IconButton(
                      icon: Icon(Icons.local_hospital),
                      onPressed: () {},
              ...
              //2nd
              Marker(
                  point: latLng.LatLng(27.684186, 85.29836),
                  builder: ((context) => Container(
                    child: IconButton(
                      icon: Icon(Icons.local_hospital),
                      onPressed: () {},
              ...
              //3rd
              Marker(
                  point: latLng.LatLng(27.6345444, 85.34423),
                  builder: ((context) => Container(
                    child: IconButton(
                      icon: Icon(Icons.local_hospital),
                      onPressed: () {},
